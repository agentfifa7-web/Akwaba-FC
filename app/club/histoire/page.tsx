...
export default async function HistoirePage() {
  const page = await getCmsPage('histoire')
  if (!page) notFound()
  return (
    <SiteChrome>
      <PageHeader kicker="Le club" title="Notre" accentTitle="histoire" description={page.subtitle ?? undefined} image={img('stadium', 1800)} />
